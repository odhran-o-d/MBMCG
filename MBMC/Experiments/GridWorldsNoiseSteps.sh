...
echo matlab -nojvm -nodesktop -nodisplay -nosplash -r "ChunkPath(); trialAverageSteps('params.in', 'results.out'); exit"

matlab -nojvm -nodesktop -nodisplay -nosplash -r "ChunkPath(); trialAverageSteps('params.in', 'results.out'); exit"
