...
echo matlab -nojvm -nodesktop -nodisplay -nosplash -r "ChunkPath(); rng('shuffle'); SAinfo_dakota('params.in', 'results.out'); exit"

matlab -nojvm -nodesktop -nodisplay -nosplash -r "ChunkPath(); rng('shuffle'); SAinfo_dakota('SAcellsBandpass', 'params.in', 'results.out'); exit"
