...
echo matlab -nojvm -nodesktop -nodisplay -nosplash -r "SAcoverage_dakota('params.in', 'results.out'); exit"

matlab -nojvm -nodesktop -nodisplay -nosplash -r "ChunkPath(); rng('shuffle'); SAcoverage_dakota('params.in', 'results.out'); exit"
